...
const EsquecerPasswordEmpresas = () => {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${apiUrl}/api/Empresas/ChangePasswordEmpresas`, {
        method: 'PUT',
        headers: {
        ...
        <div className="login-direita">
          ...
          <div className="links-login">
            <p className="registro-login">
              <Link to="/LoginEmpresas/" className="Voltar">
                Voltar
              </Link>
            </p>
          </div>
...
export default EsquecerPasswordEmpresas;